...
# All rights reserved.
# This source code is licensed under the license found in the https://github.com/facebookresearch/ssl_watermarking
...
class All(DifferentiableDataAugmentation):
    ...
    def __init__(self, degrees=30, crop_scale=(0.2, 1.0), crop_ratio=(3/4, 4/3), resize_scale=(0.2, 1.0), blur_size=17, flip=False, interpolation='bilinear'):
        """
    ...
    def apply(self, x, augmentation):
        ...
        if augm_type == 'rotation':
            ...
            s, h, w = param
            x = functional.resize(x, int((s**0.5)*min(h,w)), interpolation=self.interpolation, antialias=True)
